...
library Position {
    function getLiquidityByRange(
        ...
        (liquidity, , , , ) = pool_.positions(getPositionId(self_, lowerTick_, upperTick_));
    }

    function getPositionId(address self_, int24 lowerTick_, int24 upperTick_) public pure returns (bytes32 positionId) {

...
import {UniV3Automan, Payments} from "../../src/UniV3Automan.sol";
import "solady/src/utils/SafeTransferLib.sol";
import "@aperture_finance/uni-v3-lib/src/PoolCaller.sol";

contract LeftoverRefunded is Base {
    ...
    function testLeftover() public {
        ...
        vm.expectRevert(Payments.MismatchETH.selector);
        automan.mint{value: address(this).balance}(
            INPM.MintParams({
                token0: token0,
                token1: token1,
                fee: fee,
        ...
        require(address(automan).balance == 0, "Automan has leftover ETH !");
    }
